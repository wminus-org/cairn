...
| **14:30** | CRN-015 blur and sharpen · CRN-016 stone thread · CRN-017 stack a stone · CRN-024 nearby list | Standing 150m out, the waveform renders visibly blurred and the network response contains no audio URL. Walk in: it sharpens continuously and autoplays inside 30m. Thread renders oldest-at-bottom with author and timestamp; a new stone appears at the top of it. |
| **15:00** | CRN-023 Brief me · CRN-025 demo mode · CRN-022 live transcription *(cuttable)* | Press **Brief me** on the eleven-stone cairn and the phone speaks a synthesis out loud, unprompted, in under fifteen seconds. Demo mode toggles on and walks the fixed route with GPS off. |
...
**Hard line at 11:15.** If nothing has rendered by 11:15, take the fallback: promote CRN-024 (Nearby) to the primary surface and demo distance-gated content as a sorted list. It is a worse demo and it is a demo. Do not spend a fourth hour on native build tooling — CRN-001 is the single most likely thing to eat an hour before noon, and the mitigation is admitting it early.
