...
- Technology Park Ljubljana is approximately `[14.472, 46.047]` (lng, lat) — **verify this against an actual GPS reading on-site before you seed anything in CRN-026**. Do not trust the number in this ticket for demo seeding; trust it enough to point the camera.
